...
<head>
    ...
    <title data-react-helmet="true">Ruttl - Privacy Policy</title>
...
<body>
    <div id="___gatsby">
        <div style="outline:none" tabindex="-1" id="gatsby-focus-wrapper">
            ...
            <main class="about-styled-main">
                <section class="about-hero">
                    <div class="container">
                        <h1 style="max-width:750px">We are here to help you get your designs implemented on codes pixel perfectly</h1>
                        <div class="flex align-items-center flex-wrap">
                            <div class="about-single"><img src="/assets/img/ruttl_brain_illustration.jpg" alt="Brain illustration for about us page on ruttl"></div>
                            <div class="about-text">
                                <p>In conventional website review, clients take screenshots, encircle the issues, and share a Word doc with the developer or project manager. Alternatively, they sit with the developers and ask them to make the changes, but these processes are very tedious and time-taking. On an average, a single page takes around 3-4 hours to review and still, the final output is just close to perfection.</p>
                                <p>That’s why we created ruttl. ruttl lets you make edits to live websites and share contextual, visual feedback with your team members. It also allows you to leave comments on live website. ruttl has a lot of competitive advantages, which you can check here. Built by designers &amp; developers, ruttl is the future of design review. ruttl has a lot of competitive advantages,&nbsp;<a href="/">check here.</a></p><a class="button" href="/">ruttl’s origin story<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512"><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path></svg></a></div>
                        </div>
                    </div>
                </section>
                <section class="ruttl-team">
                    <div class="container">
                        <div class="flex flex-wrap">
                            <div class="team-image-block">
                                <h2>The team behind ruttl</h2>
                                <div class="team-mem">
                                    <div class="team-logo"><img src="/assets/img/brucira-logo.svg" alt="Brucira"></div>
                                    <div class="mem-img">
                                        <video src="/assets/video/team-members.mp4" autoplay="" loop="" muted="" poster="/assets/img/team-members.jpg" playsinline=""></video>
                                    </div>
                                </div>
                            </div>
                            <div class="team-text-block">
                                <p><a href="/">ruttl</a>&nbsp;is the brainchild of designers &amp; developers over at Brucira who were frustrated with the clunky, time-consuming nature of the old design review process. As the idea for a design review tool grew, we’ve added more features from our beta users’ suggestions and our audience interactions. In fact, we’ve coded &amp; reviewed ruttl on ruttl — talk about a ruttlception!!</p>
                                <p>Over at Brucira, a product design agency, our designers &amp; developers work across website designs, illustrations, mobile apps, and so much more. So, we know the value of a useful design review tool. We built ruttl to be an internal tool and having seen its success at Brucira, we’re excited to share it with other creators!</p>
                                <a href="https://www.linkedin.com/" target="_blank" class="button"><img src="/assets/img/linkedin-white.svg" alt="linkedin">Follow ruttl on Linkedin
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
                                        <path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="48" d="M268 112l144 144-144 144M392 256H100"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
                ...
                <section class="styled-get-started">
                    <div class="container">
                        <div class="flex flex-wrap align-items-center">
                            <div class="index-get-started-text reveal-1">
                                <h2>Experience the future of design review with ruttl </h2>
                                <div class="get-started-buttons">
                                    <button type="button" class="button">Get started for free</button>
                                    <button type="button" class="button button-white">Watch Demo</button>
                                </div>
                            </div>
                            <div class="index-get-started-scroll">
                                <div class="scroll-single"></div>
                                <div class="scroll-single scroll-2"></div>
                            </div>
                        </div>
                    </div>
                    <div id="footer-demo-modal" class="demo-modal">
                        <button type="button" class="button-unstyled"><img src="/assets/img/close.svg" alt="close" title="close"></button>
                    </div>
                </section>
            </main>
