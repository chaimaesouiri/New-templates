...
name='robots' content='noindex, nofollow'><title>Privacy Policy - SmartSites</title><meta
name="description" content="Read SmartSites&#039; Privacy Policy."><meta
property="og:locale" content="en_US"><meta
property="og:type" content="article"><meta
property="og:title" content="Privacy Policy - SmartSites"><meta
property="og:description" content="Read SmartSites&#039; Privacy Policy."><meta
property="og:url" content="<?=$host?>/privacy-policy/"><meta
property="og:site_name" content="SmartSites"><meta
property="article:publisher" content="https://www.facebook.com/SmartSites"><meta
property="article:modified_time" content="2020-07-03T07:57:08+00:00"><meta
name="twitter:card" content="summary_large_image"><meta
name="twitter:site" content="@SmartSitesNJ"><meta
name="twitter:label1" content="Est. reading time"><meta
name="twitter:data1" content="5 minutes"> <script type=application/ld+json class=yoast-schema-graph>{"@context":"https://schema.org","@graph":[{"@type":"WebPage","@id":"<?=$host?>/privacy-policy/","url":"<?=$host?>/privacy-policy/","name":"Privacy Policy - SmartSites","isPartOf":{"@id":"<?=$host?>/#website"},"datePublished":"2018-06-21T04:57:07+00:00","dateModified":"2020-07-03T07:57:08+00:00","description":"Read SmartSites' Privacy Policy.","breadcrumb":{"@id":"<?=$host?>/privacy-policy/#breadcrumb"},"inLanguage":"en-US","potentialAction":[{"@type":"ReadAction","target":["<?=$host?>/privacy-policy/"]}]},{"@type":"BreadcrumbList","@id":"<?=$host?>/privacy-policy/#breadcrumb","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"<?=$host?>/"},{"@type":"ListItem","position":2,"name":"Privacy Policy"}]},{"@type":"WebSite","@id":"<?=$host?>/#website","url":"<?=$host?>/","name":"SmartSites","description":"Think Web. Think Smart.","publisher":{"@id":"<?=$host?>/#organization"},"potentialAction":[{"@type":"SearchAction","target":{"@type":"EntryPoint","urlTemplate":"<?=$host?>/?s={search_term_string}"},"query-input":"required name=search_term_string"}],"inLanguage":"en-US"},{"@type":"Organization","@id":"<?=$host?>/#organization","name":"SmartSites","url":"<?=$host?>/","logo":{"@type":"ImageObject","inLanguage":"en-US","@id":"<?=$host?>/#/schema/logo/image/","url":"<?=$host?>/media/smartsites-logo.png","contentUrl":"<?=$host?>/media/smartsites-logo.png","width":185,"height":50,"caption":"SmartSites"},"image":{"@id":"<?=$host?>/#/schema/logo/image/"},"sameAs":["https://www.linkedin.com/company/smartsites","https://www.pinterest.com/smartsites/","https://www.facebook.com/SmartSites","https://twitter.com/SmartSitesNJ"]}]}</script> <link
...
rel=stylesheet href=<?=$host?>/wp-content/cache/minify/36781.css media=all> <script async src=<?=$host?>/wp-content/cache/minify/8a587.js></script> <script src='<?=$host?>/wp-includes/js/jquery/jquery.min.js?ver=3.6.0' id=jquery-core-js></script> <script id=lazy-jquery-plugins-js-extra>var lazyPlugins=[{"name":"mCustomScrollbar","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/scroll\/jquery.mCustomScrollbar.min.js","css":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/scroll\/jquery.mCustomScrollbar.min.css"},{"name":"flickity","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/flickity\/flickity.pkgd.min.js","css":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/flickity\/flickity.css"},{"name":"slick","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/slick\/slick.min.js","css":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/slick\/slick.css"},{"name":"multiselect","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/multi-select\/bootstrap-multiselect.js","css":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/multi-select\/bootstrap-multiselect.css"},{"name":"matchHeight","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/match-height\/jquery.matchHeight.js"},{"name":"stickySidebar","js":"https:\/\/<?=$ihost?>\/wp-content\/themes\/smartsites\/vendors\/sticky-sidebar\/jquery.sticky-sidebar.js"}];</script> <script async src=<?=$host?>/wp-content/cache/minify/ca199.js></script> <link
rel=https://api.w.org/ href=<?=$host?>/wp-json/ ><link
rel=alternate type=application/json href=<?=$host?>/wp-json/wp/v2/pages/3><link
...
class="privacy-policy page-template-default page page-id-3 has-sidebar">
<svg
...
<header
id=header class="site-header site-header--alt"><nav
id=top-header-nav class="navbar navbar-expand-xl navbar-light">
<a
class=navbar-brand href=<?=$host?>/ ><img
src=<?=$host?>/wp-content/themes/smartsites/images/smartsites-logo.svg alt="SmartSites Digital Marketing Agency" width=208 height=43></a><div
class="collapse navbar-collapse collapse-block" id=navbarToggler><div
id=navbarToggler class="collapse navbar-collapse collapse-block">
...
class=container><div
class=row><div
class="col-lg-6 col-md-12 footer__top-form" data-aos=fade-right data-aos-duration=1000> <script>var gform;gform||(document.addEventListener("gform_main_scripts_loaded",function(){gform.scriptsLoaded=!0}),window.addEventListener("DOMContentLoaded",function(){gform.domLoaded=!0}),gform={domLoaded:!1,scriptsLoaded:!1,initializeOnLoaded:function(o){gform.domLoaded&&gform.scriptsLoaded?o():!gform.domLoaded&&gform.scriptsLoaded?window.addEventListener("DOMContentLoaded",o):document.addEventListener("gform_main_scripts_loaded",o)},hooks:{action:{},filter:{}},addAction:function(o,n,r,t){gform.addHook("action",o,n,r,t)},addFilter:function(o,n,r,t){gform.addHook("filter",o,n,r,t)},doAction:function(o){gform.doHook("action",o,arguments)},applyFilters:function(o){return gform.doHook("filter",o,arguments)},removeAction:function(o,n){gform.removeHook("action",o,n)},removeFilter:function(o,n,r){gform.removeHook("filter",o,n,r)},addHook:function(o,n,r,t,i){null==gform.hooks[o][n]&&(gform.hooks[o][n]=[]);var e=gform.hooks[o][n];null==i&&(i=n+"_"+e.length),gform.hooks[o][n].push({tag:i,callable:r,priority:t=null==t?10:t})},doHook:function(n,o,r){var t;if(r=Array.prototype.slice.call(r,1),null!=gform.hooks[n][o]&&((o=gform.hooks[n][o]).sort(function(o,n){return o.priority-n.priority}),o.forEach(function(o){"function"!=typeof(t=o.callable)&&(t=window[t]),"action"==n?t.apply(null,r):r[0]=t.apply(null,r)})),"filter"==n)return r[0]},removeHook:function(o,n,t,i){var r;null!=gform.hooks[o][n]&&(r=(r=gform.hooks[o][n]).filter(function(o,n,r){return!!(null!=i&&i!=o.tag||null!=t&&t!=o.priority)}),gform.hooks[o][n]=r)}});</script> <div
class='gf_browser_gecko gform_wrapper form-display2_wrapper gform_legacy_markup_wrapper' id=gform_wrapper_2 style=display:none><div
class=gform_heading><h3 class="gform_title">Get Started</h3></div><form
method=post enctype=multipart/form-data target=gform_ajax_frame_2 id=gform_2 class='form-display2 gform_legacy_markup' action=/privacy-policy/ novalidate><div
...
class=gfield_label for=input_2_2 >Email Address<span
class=gfield_required><span
class="gfield_required gfield_required_asterisk">*</span></span></label><div
...
class=gfield_label for=input_2_3 >Phone Number<span
class=gfield_required><span
class="gfield_required gfield_required_asterisk">*</span></span></label><div
...
class=gfield_label for=input_2_4 >Company</label><div
class='ginput_container ginput_container_text'><input
...
class=gfield_label for=input_2_24 >Services you are interested in*<span
class=gfield_required><span
class="gfield_required gfield_required_asterisk">*</span></span></label><div
...
value='WEBSITE DESIGN' >Website Design &amp; Development</option><option
value=SEO >Search Engine Optimization</option><option
value=PPC >Pay Per Click Marketing</option><option
value='Email Marketing' >Email &amp; SMS Marketing</option><option
value='Social Media' >Social Media Management</option><option
...
class=gfield_label for=input_2_8 >Other (Please Specify)<span
class=gfield_required><span
class="gfield_required gfield_required_asterisk">*</span></span></label><div
class='ginput_container ginput_container_text'><input
...
class=gfield_label for=input_2_6 >How can we help you?</label><div
...
class="slide m-0 blockquote position-relative"><p>SmartSites helped to develop my website. They did a great job and I noticed the positive results almost immediately. They are very professional and very pleasant to work with. I am very happy with the services provided.</p><div
class="blockquote-footer text-white">New Jersey Mediation <cite
title="Source Title" class=font-weight-normal>Maryana Kanda</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote><blockquote
class="slide m-0 blockquote position-relative"><p>After a nightmare experience with other marketing companies, I finally found a hard working group who actually know what they are doing. They handle all of my ads as and designed a website. Business has doubled since we started. Looking forward to more success.</p><div
class="blockquote-footer text-white">Agape Health Wellness Center <cite
title="Source Title" class=font-weight-normal>Dr. Larry Bennett</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote><blockquote
class="slide m-0 blockquote position-relative"><p>They showed me great results fast. SmartSites manages the website and SEO initiatives. We recently expanded our location and continue to drive appointments through the digital marketing. I highly recommend SmartSites!</p><div
class="blockquote-footer text-white">Studio Esthetique <cite
title="Source Title" class=font-weight-normal>Vladimir Byhovsky</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote><blockquote
class="slide m-0 blockquote position-relative"><p>Smartsites is a one stop shop to outsource your website, online marketing and also content. The staff is very knowledgeable and also responsive.</p><div
class="blockquote-footer text-white">Englewood Cliffs News <cite
title="Source Title" class=font-weight-normal>William Woo</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote><blockquote
class="slide m-0 blockquote position-relative"><p>I had a great experience working with SmartSites and wouldn’t hesitate to recommend them. The level of customer service, marketing skills, and efficiency was beyond the scope of my expectations!</p><div
class="blockquote-footer text-white">Perfect Dashboard <cite
title="Source Title" class=font-weight-normal>Bartek Jaz</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote><blockquote
class="slide m-0 blockquote position-relative"><p>Proved to be an invaluable resource. From the conception of an idea through implementation, SmartSites was there to ensure the final matched our vision. They take the time to learn their clients’ business inside and out.</p><div
class="blockquote-footer text-white">Sharemoney <cite
title="Source Title" class=font-weight-normal>Steven Taylor</cite>
<a
href='<?=$host?>' class="blockquote-link text-underline">View 100+ More Testimonials</a></div></blockquote></div></div><div
...
class="d-block text-primary font-weight-normal h6">Follow us on</small>Facebook</a></h5></div></div></div><div
...
class=heading-wrap><h4>Recent Posts</h4></div><ul
class=recent-post-listings>
<li>
<span
class=post-date>Posted on September 24, 2023</span><h5><a
href='<?=$host?>' >How to Save Money on Processing Fees: An Exclusive Offer for SmartSites Clients</a></h5>
<a
href='<?=$host?>' class=read-more>Read More <i
class=icon-arrow-right></i></a>
</li>
<li>
<span
class=post-date>Posted on September 7, 2023</span><h5><a
href=<?=$host?>/ >YouTube SEO: The Key to Video Success</a></h5>
<a
href=<?=$host?>/ class=read-more>Read More <i
class=icon-arrow-right></i></a>
</li>
<li>
<span
class=post-date>Posted on September 6, 2023</span><h5><a
href='<?=$host?>' >The One Thing Webinar: E-commerce Strategies To Enhance Customer Lifetime Value</a></h5>
<a
href='<?=$host?>' class=read-more>Read More <i
class=icon-arrow-right></i></a>
</li></ul></div></div>
<div class="footer-nav" style=" margin: auto; text-align: center; display: flex; ">
    <p style=" margin: 0px 10px; "><a href="<?=$host?>/terms-of-service">Terms Of Service</a></p>
    <p style=" margin: 0px 10px; "><a href="<?=$host?>/privacy-policy">Privacy Policy</a></p>
    <p style=" margin: 0px 10px; "><a href="<?=$host?>/refund-policy">Refund policy</a></p>
    <p style=" margin: 0px 10px; "><a href="<?=$host?>/about-us">about us</a></p>
    <p style=" margin: 0px 10px; "><a href="<?=$host?>/delivery-policy">delivery policy</a></p>
</div>
</div>
</template></div>
<div class="footer__bottom container-fluid"><div class=row><div class=col-lg-8>
<span class="footer__copyright d-inline-block"> &copy; 2023 <a href='<?=$host?>'>SmartSites</a>. All Rights Reserved. <a
rel=nofollow href=<?=$host?>/privacy-policy >Privacy Policy</a>
</span>
<address
class="footer-address d-inline-block m-0"> Address: 45 Eisenhower Drive, Suite 520
Paramus, NJ 07652
</address></div></div></div><div
class=sticky-footer>
<a
href=tel:2018706000 class="btn btn-primary"><span
class=icon-phone-alt></span> Call</a>
<a
href=# class="btn btn-primary" data-toggle=modal data-target=#smartsites-meeting><span
class=icon-calender></span> Meet</a></div></footer>
...
aria-hidden=true>&times;</span></button><p>We are aware of active scams in India using the SmartSites brand name. We are not associated with these scams. SmartSites does not solicit employment over Telegram. All SmartSites employment is done via @<?=$ihost?> emails. If you are being scammed over Telegram, please report it to abuse@telegram.org. The only website that represents the SmartSites brand is <?=$ihost?>.</p></div></div></div>
...
class="modal fade tolstoy-modal exit-intent-modal" id=tolstoy-video tabindex=-1 role=dialog aria-hidden=true><div
class="modal-dialog modal-lg modal-dialog-centered" role=document><div
class=modal-content>
<button
type=button class=close data-dismiss=modal aria-label=Close><span
aria-hidden=true>&times;</span></button><div
class=iframe-wrapper><div
class=tolstoy-player-content><h2>Exceed Your Goals With The Right Digital Marketing Partner</h2><div
id=tolstoy-container class=tolstoy-video__wrap>
<iframe
id=tolstoy data-src=https://player.gotolstoy.com/cm85adwryqqle?host scrolling=no
frameborder=0 allow="autoplay *">
</iframe></div>
<a
class="btn btn-primary" href=# data-toggle=modal data-target=#smartsites-meeting data-source=tolstoy_popup>Schedule a Meeting</a></div></div></div></div></div> <script id=wpil-frontend-script-js-extra>var wpilFrontend={"ajaxUrl":"\/wp-admin\/admin-ajax.php","postId":"3","postType":"post","openInternalInNewTab":"0","openExternalInNewTab":"1","disableClicks":"0","openLinksWithJS":"0","trackAllElementClicks":"0","clicksI18n":{"imageNoText":"Image in link: No Text","imageText":"Image Title: ","noText":"No Anchor Text Found"}};</script> <script async src=<?=$host?>/wp-content/cache/minify/3afb2.js></script> <script id=jquery-fancybox-js-after>var fb_timeout,fb_opts={'overlayShow':true,'hideOnOverlayClick':true,'showCloseButton':true,'margin':20,'enableEscapeButton':true,'autoScale':true};if(typeof easy_fancybox_handler==='undefined'){var easy_fancybox_handler=function(){jQuery([".nolightbox","a.wp-block-fileesc_html__button","a.pin-it-button","a[href*='pinterest.com\/pin\/create']","a[href*='facebook.com\/share']","a[href*='twitter.com\/share']"].join(',')).addClass('nofancybox');jQuery('a.fancybox-close').on('click',function(e){e.preventDefault();jQuery.fancybox.close()});var fb_IMG_select=jQuery('a[href*=".jpg" i]:not(.nofancybox,li.nofancybox>a),area[href*=".jpg" i]:not(.nofancybox),a[href*=".jpeg" i]:not(.nofancybox,li.nofancybox>a),area[href*=".jpeg" i]:not(.nofancybox),a[href*=".png" i]:not(.nofancybox,li.nofancybox>a),area[href*=".png" i]:not(.nofancybox),a[href*=".webp" i]:not(.nofancybox,li.nofancybox>a),area[href*=".webp" i]:not(.nofancybox)');fb_IMG_select.addClass('fancybox image');jQuery('a.fancybox,area.fancybox,.fancybox>a').each(function(){jQuery(this).fancybox(jQuery.extend(true,{},fb_opts,{'transitionIn':'elastic','easingIn':'easeOutBack','transitionOut':'elastic','easingOut':'easeInBack','opacity':false,'hideOnContentClick':false,'titleShow':false,'titlePosition':'over','titleFromAlt':true,'showNavArrows':true,'enableKeyboardNav':true,'cyclic':true}))});};};jQuery(easy_fancybox_handler);jQuery(document).on('post-load',easy_fancybox_handler);</script> <script async src=<?=$host?>/wp-content/cache/minify/e7db6.js></script> <script src='<?=$host?>/wp-includes/js/dist/i18n.min.js?ver=ebee46757c6a411e38fd079a7ac71d94' id=wp-i18n-js></script> <script id=wp-i18n-js-after>wp.i18n.setLocaleData({'text direction\u0004ltr':['ltr']});</script> <script async src=<?=$host?>/wp-content/cache/minify/aba2a.js></script> <script id=gform_gravityforms-js-extra>var gform_i18n={"datepicker":{"days":{"monday":"Mon","tuesday":"Tue","wednesday":"Wed","thursday":"Thu","friday":"Fri","saturday":"Sat","sunday":"Sun"},"months":{"january":"January","february":"February","march":"March","april":"April","may":"May","june":"June","july":"July","august":"August","september":"September","october":"October","november":"November","december":"December"},"firstDay":0,"iconText":"Select date"}};var gf_legacy_multi=[];var gform_gravityforms={"strings":{"invalid_file_extension":"This type of file is not allowed. Must be one of the following:","delete_file":"Delete this file","in_progress":"in progress","file_exceeds_limit":"File exceeds size limit","illegal_extension":"This type of file is not allowed.","max_reached":"Maximum number of files reached","unknown_error":"There was a problem while saving the file on the server","currently_uploading":"Please wait for the uploading to complete","cancel":"Cancel","cancel_upload":"Cancel this upload","cancelled":"Cancelled"},"vars":{"images_url":"https:\/\/<?=$ihost?>\/wp-content\/plugins\/gravityforms\/images"}};var gf_global={"gf_currency_config":{"name":"U.S. Dollar","symbol_left":"$","symbol_right":"","symbol_padding":"","thousand_separator":",","decimal_separator":".","decimals":2,"code":"USD"},"base_url":"https:\/\/<?=$ihost?>\/wp-content\/plugins\/gravityforms","number_formats":[],"spinnerUrl":"https:\/\/<?=$ihost?>\/wp-content\/plugins\/gravityforms\/images\/spinner.svg","strings":{"newRowAdded":"New row added.","rowRemoved":"Row removed","formSaved":"The form has been saved.  The content contains the link to return and complete the form."}};</script> <script async src=<?=$host?>/wp-content/cache/minify/24d96.js></script> <script id=gform_conditional_logic-js-extra>var gf_legacy={"is_legacy":"1"};</script> <script async src=<?=$host?>/wp-content/cache/minify/adcb0.js></script> <script defer src=<?=$host?>/wp-content/cache/minify/45ffb.js></script> <script>(function($){$(document).on('gform_post_render',function(event,form_id,current_page){$('form[id^="gform_"][action*="?"]').attr('action',window.location.href);});})(jQuery)</script> 
