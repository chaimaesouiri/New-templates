...
<head>
    ...
    <title><?=$namehost?> | Delivery Policy</title>
...
<body>
    <div id="__next">
        <div class="PageTemplate_root__z_EYX">
                        ...
                        <div class="BurgerMenu_root__7i__7">
                            <div>
                                <svg width="18" height="14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 7a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1ZM0 1a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1ZM0 13a1 1 0 0 1 1-1h16a1 1 0 1 1 0 2H1a1 1 0 0 1-1-1Z" fill="#555"></path>
                                </svg>
                            </div>
            ...
            <main class="PageTemplate_content__wv_Y9">
                <div class="Container_root__qvtQX">
                    <article class="PolicyArticleRoot_root___pe9W">
                        <div class="PrivacyPolicyInfo_title-wrapper__WNZo1">
                            <h2 class="H2_root___jvs6">Delivery Policy</h2></div>
