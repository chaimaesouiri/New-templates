...
<body class="">
    ...
    <main id="plain">
        <section id="plain-header" class="hero-section">
            <h1 class="page-headline">Refund policy</h1>
        </section>
        <section id="plain-body">
            <div class="container">
               <div class="content-article ng-scope" data-ng-if="article.type == 'question'">
                <div data-ng-bind-html="article.description" class="ng-binding"><p><?=$namehost?> offers a free trial (you can renew it once), no credit card requirements. You can fully test the platform for free for 30 days, without charge.<br></p>
<p>Once you subscribe to a plan, you’re charged automatically every month/year according to your subscription date.</p>
<p>When you cancel your subscription, you cancel the automatic renewal and we maintain full access to the tool until the end of your billing cycle.</p>
<p>We don't offer a refund for our monthly subscriptions.</p>
<p>You may be entitled to a partial refund <b>if you cancel an annual subscription within the first 30 days of the renewal date. (self-service subscriptions only)</b></p>
<p>In that case, please follow the steps explained <a href="">here</a> and once you’re done, contact us at <a href="mailto:cs@<?=$ihost?>">cs@<?=$ihost?></a>.&nbsp; We will evaluate if you are entitled to a partial refund. Please note that if you are entitled to a partial refund, this involves an immediate termination of services.</p></div>
            </div>
            </div>
        </section>
    </main>
