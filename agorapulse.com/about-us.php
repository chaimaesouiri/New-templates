...
<body class="">
    ...
    <main id="plain">
        <section id="plain-header" class="hero-section">
            <h1 class="page-headline">about us</h1>
        </section>
        <section id="plain-body">
            <div class="container">
               <div class="content-article ng-scope" data-ng-if="article.type == 'question'">
                <div data-ng-bind-html="article.description" class="ng-binding">
                <h4>We are on a mission to make data analysis simpler, more productive and more connected.</h4>
